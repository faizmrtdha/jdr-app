        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body add-post">
              <form action="/dashboard/role/{{ $data->id }}" method="post" class="row needs-validation" >
                @method('put')
                @csrf
                ...
                <div class="col-sm-12">
                  <div class="mb-3">
                    ...
                    <input class="form-control @error('role-name') is-invalid @enderror" id="role-name" name="role-name" type="text" placeholder="Role Name" value="{{ old('role-name', $data->{'role-name'}) }}" >
                      @error('role-name')
